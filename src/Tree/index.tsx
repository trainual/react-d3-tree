...
import { max as d3Max, min as d3Min, sum as d3Sum, cumsum as d3Cumsum} from 'd3'
...
import {TreeNodeDatum, Point, RawNodeDatum, TreeNode} from '../types/common';
import { TreeLinkEventCallback, TreeNodeEventCallback, TreeProps } from './types';
import {HorizontalDefaultLayout, VerticalDefaultLayout} from '../CompactLayout/LayoutDefaults'
import globalCss from '../globalCss';
import {calculateCompactFlexDimensions, calculateCompactFlexPositions} from "../CompactLayout/CompactLayoutHelper";
...
class Tree extends React.Component<TreeProps, TreeState> {
  ...
  private compactLayout: CompactLayoutConfiguration | undefined;
   ...
   */
  setInitialTreeDepth(nodeSet: TreeNode[], initialDepth: number) {
    nodeSet.forEach(n => {
   ...
   */
  centerNode = (hierarchyPointNode: TreeNode) => {
   ...
   */
  generateTree() {
    const { initialDepth, depthFactor, separation, nodeSize, orientation, compact } = this.props;
    ...
    if(compact) {
      calculateCompactFlexPositions(rootNode, this.compactLayout);
    }
   ...
   */
  getNodeClassName = (parent: TreeNode, nodeDatum: TreeNodeDatum) => {
