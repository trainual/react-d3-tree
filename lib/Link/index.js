...
var Link = /** @class */ (function (_super) {
    ...
    Link.prototype.drawSmoothStepPath = function (linkData, orientation, compactLayout) {
        var n = linkData.target.data.__rd3t.compact.flexCompactDim
            ? {
        ...
        var m = linkData.target.data.__rd3t.compact.flexCompactDim
            ? {
    ...
    Link.prototype.getSmoothPathSvg = function (s, t, m) {
        var x = s.x;
        var y = s.y;
        var ex = t.x;
        var ey = t.y;
    ...
    Link.prototype.drawPath = function () {
        var _a = this.props, linkData = _a.linkData, orientation = _a.orientation, pathFunc = _a.pathFunc, compact = _a.compact, compactLayout = _a.compactLayout;
    ...
    Link.prototype.getClassNames = function () {
        var _a = this.props, linkData = _a.linkData, orientation = _a.orientation, pathClassFunc = _a.pathClassFunc, compact = _a.compact, compactLayout = _a.compactLayout;
